  ...
  constructor() {
    this.data = {
      ...
      content: `
        ...
        <p>I'm currently...</p>
        <ul>
          <li>(Soon!) Leading high-impact AI projects at UWaterloo's AI Team, <a href="https://watai.ca/" target="_blank" rel="noopener noreferrer" class="link">WAT.ai <img src="/assets/pictures/watai.png" alt="WAT.ai" class="project-logo"></a></li>
