  ...
  constructor() {
    this.data = {
      ...
      content: `
        ...
        <p>I'm currently...</p>
        <ul>
          <li>Leading a <a href="https://watai.ca/" target="_blank" rel="noopener noreferrer" class="link">WAT.ai <img src="/assets/logos/watai.png" alt="WAT.ai" class="project-logo"></a> × <a href="https://bindwell.ai/" target="_blank" rel="noopener noreferrer" class="link">Bindwell <img src="/assets/logos/bindwell.png" alt="Bindwell" class="project-logo"></a> (YC W25) collaboration to accelerate the regulatory approval of new, safer AI-discovered pesticides</li>
