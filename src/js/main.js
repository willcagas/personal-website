    ...
    return `
      <section class="panel panel-meta page-content">
        ...
        <div class="meta-section">
          ...
          <p class="about-bio">The balance between knowledge and application lies in learning by doing. I want to keep evolving by shipping and iterating on software to solve real-world problems and reach real users.</p>
          <p class="about-bio">I’m especially drawn to ambitious people and environments where curiosity, initiative, and momentum matter.</p>
